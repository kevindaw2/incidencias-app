...
class UserModel extends Model implements IModel{
    ...
    function updateName($name, $iduser){
        try{
            $query = $this->db->connect()->prepare('UPDATE users SET username = :val WHERE id = :id');
    ...
    public function save(){
        try{
            $query = $this->prepare('INSERT INTO users (username, password, role, mail) VALUES(:username, :password, :role, :mail)');
            $query->execute([
    ...
    public function update(){
        try{
            $query = $this->prepare('UPDATE users SET username = :username, password = :password, mail = :mail WHERE id = :id');
            $query->execute([
                'id'        => $this->id,
                'username' => $this->username, 
                'password' => $this->password,
